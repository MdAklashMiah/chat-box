...
const Not_found = () => {
  return (
    <>
  {/* component */}
  <main className="h-screen w-full flex flex-col justify-center items-center bg-[#1D3557]">
    <h1 className="text-9xl font-extrabold text-[#457B9D] tracking-widest">404</h1>
    <div className="bg-[#1D3557] text-white px-2 text-sm rounded rotate-12 absolute">
      Page Not Found
    </div>
